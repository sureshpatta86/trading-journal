      ...
      <div className={`${sizes[size]} relative`}>
        ...
        >
          ...
          <g transform="translate(12, 16)">
            ...
            {/* Trend Line */}
            <path
              d="M4 28 L12 22 L20 18 L28 16 L36 12"
              stroke="#fbbf24"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
          ...
          <g transform="translate(44, 44)">
            <circle cx="8" cy="8" r="7" fill="#fbbf24" stroke="#f59e0b" strokeWidth="1" />
            <path
              d="M6 5.5 C6 4.5 6.8 4 8 4 C9.2 4 10 4.5 10 5.5 M6 10.5 C6 11.5 6.8 12 8 12 C9.2 12 10 11.5 10 10.5 M8 3 L8 13 M8 4 L8 12"
              stroke="white"
              strokeWidth="1.5"
              fill="none"
              strokeLinecap="round"
